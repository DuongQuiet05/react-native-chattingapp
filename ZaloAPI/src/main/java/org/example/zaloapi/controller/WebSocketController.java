...
public class WebSocketController {
    ...
    public void sendMessage(@Payload ChatMessage chatMessage, Principal principal) {
        try {
            ...
            // Create response message với đầy đủ thông tin
            ...
            // Send to conversation topic - tất cả participants sẽ nhận được
            messagingTemplate.convertAndSend(
                    "/topic/conversations/" + chatMessage.getConversationId(),
                    response
            );

            System.out.println("✅ [WebSocket] Message broadcasted successfully");
